...
ud <- calcUdHgtColony(.col_sel = col_sel, .age = age, .scale = FALSE,
...
raster::writeRaster(r_gamfit, paste0("analysis/output/enc_hgt_hazard_",
                                     col_sel$id, "_", age, ".tif"),
                    overwrite = TRUE)
...
raster::writeRaster(r_gamfit,
                    paste0("analysis/output/enc_hgt_hazard_", age, ".tif"),
                    overwrite = TRUE)
...
# Save raster file
raster::writeRaster(r_gamfit,
                    paste0("analysis/output/enc_hgt_risk_", age, ".tif"),
                    overwrite = TRUE)
...
r <- raster::raster("analysis/output/enc_hazard_juv.tif")
